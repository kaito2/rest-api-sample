...
func UsageCommands() string {
	return `echo-service (version|echo-get)
`
}

// UsageExamples produces an example of a valid invocation of the CLI tool.
func UsageExamples() string {
	return os.Args[0] + ` echo-service version` + "\n" +
		""
}
...
func ParseEndpoint(
	...
	var (
		...
		echoServiceVersionFlags = flag.NewFlagSet("version", flag.ExitOnError)
	...
	echoServiceVersionFlags.Usage = echoServiceVersionUsage
...
func echoServiceVersionUsage() {
	fmt.Fprintf(os.Stderr, `%s [flags] echo-service version

Version implements version.

Example:
    `+os.Args[0]+` echo-service version
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` echo-service echo-get --name "Et quam et molestias." --age 6027251967805643844
`, os.Args[0])
}
